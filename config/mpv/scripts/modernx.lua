...
local user_opts = {
    ...
    deadzonesize = 1.0,         -- size of deadzone
    ...
    showonstart = false,        -- show OSC on startup or when the next file in
...
function layout()
    ...
    lo.geometry = {x = 97, y = refY - 20, an = 5, w = 24, h = 24}
    lo.style = osc_styles.smallButtons
    ...
    lo.geometry = {x = osc_geo.w - 67, y = refY - 20, an = 5, w = 24, h = 24}
    lo.style = osc_styles.smallButtons
